...
/*
 * The path to output each frame at (should not include the extension)
 * If it is NULL or "-", the frame(s) are written to stdout
 */
extern char *output_path;

// TODO - figure out how to handle formatting and extensions
